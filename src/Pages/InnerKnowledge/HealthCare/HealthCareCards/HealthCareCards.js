			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
					...
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Putting Healthcare & Fitness ventures at the forefront of the evolving field
						...
						<Fade bottom>
							<p className='font-300 text-center mt-4 '>
								...
								Technologies, we equip Healthcare & Fitness businesses with solutions or insights
								with which you can envision a future of possibilities and take next steps with the
								faith towards success and growth.
							</p>
						</Fade>
					</Col>{' '}
				</Row>
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Potential Uses Of Blockchain In Healthcare & Fitness
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>
										Enhanced Prevention Against Fraudulence In Sensitive Data
									</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									...
									<p className='mb-0 font-400'>
										Real-Time Recording Of Health Insurance, Medical Records & Patient’s Smart
										Contracts Data
									</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									...
									<p className='mb-0 font-400'>Transparency In Patient Healthcare Benefits</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
				...
				<Row className='align-items-center justify-content-center'>
					...
					<Col md lg={6} className='position-relative py-5'>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of AI-ML In Healthcare & Fitness
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>Analysis Of Patient’s Day-To-Day Health Patterns</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Early Detection Of Various Diseases</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Enables Implementation Of Quick Medical Decisions</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Analysis Of Body Scan Patterns</p>
								</div>
							</div>
						</Fade>
					</Col>
			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
				<Row className='align-items-center justify-content-center'>
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Where Do You Stand With New-Age tech’s Possibilities For The Healthcare & Fitness
								Sector?
							</h1>
						</Fade>
						...
						<Fade bottom>
							<p className='font-300 text-center mt-4 '>
								We’ll take it from here. We’ll draft the perfect plan your Healthcare & Fitness
								business.
							</p>
						</Fade>
						<Row className='align-items-center justify-content-center py-4'>
