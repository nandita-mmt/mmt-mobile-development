			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
					...
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Putting Real Estate sector at the forefront of the evolving field empowered by
						...
						<Fade bottom>
							<p className='font-300 text-center mt-4 '>
								...
								Technologies, we equip Real Estate businesses with solutions or insights with which
								you can envision a future of possibilities and take next steps with the faith
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Potential Uses Of Blockchain In Real Estate Sector
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>Tokenisation Of Real-Estate Funds</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Catalyzation Of Real Estate Investment</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Strengthens Security & Financing</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Enables Accurate Property Management</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Fast-tracks Land Registries</p>
								</div>
							</div>
						</Fade>
					</Col>
				...
				<Row className='align-items-center justify-content-center'>
					...
					<Col md lg={6} className='position-relative py-5'>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of AI-ML In Real Estate Sector
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>Enhances Marketing & Lead Generation</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Predicts Market Value Of The Property</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									...
									<p className='mb-0 font-400'>
										Recommends Property To Customers Studying Their Preference Patterns
									</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
									...
									<p className='mb-0 font-400'>
										Enables Streamlined & Seamless Property Management
									</p>
								</div>
							</div>
						</Fade>
				...
				<Row className='align-items-center justify-content-center'>
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of Core Tech In Real Estate Sector
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
				<Row className='align-items-center justify-content-center'>
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Where Do You Stand With New-Age tech’s Possibilities For The Real Estate Sector?
							</h1>
						</Fade>
					...
					<Col md lg={12}>
						...
						<Fade bottom>
							<p className='font-300 text-center mt-5 pt-3'>
								...
								ventures of every sizes envision a new path of functionality for the future.
							</p>
						</Fade>
					</Col>{' '}
