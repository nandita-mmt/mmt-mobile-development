			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
					...
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Putting your Automotive venture at the forefront of the evolving field empowered by
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Potential Uses Of Blockchain In Automotive
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>
										Enabling Vehicle Owners To Pay For Fuel Through Cryptocurrency
									</p>
								</div>
								...
								<div className='d-flex flex-row justify-content-start align-items-start'>
									...
									<p className='mb-0 font-400'>De-Centralising Ridesharing</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									...
									<p className='mb-0 font-400'>
										Enabling Smart Contracts & Streamlining Supply Chain Management For Vehicle
										Manufacturers
									</p>
								</div>
							</div>
				...
				<Row className='align-items-center justify-content-center'>
					...
					<Col md lg={6} className='position-relative py-5'>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of AI-ML In Automotive
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>Manufacturing Analytics</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Vehicle Recommendations</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Driver Behavior Analytics</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Road Condition Analytics</p>
								</div>
							</div>
						</Fade>
					</Col>
				...
				<Row className='align-items-center justify-content-center'>
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of Core Tech In Automotive
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
				<Row className='align-items-center justify-content-center'>
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Where Do You Stand With New-Age tech’s Possibilities For The Automotive Sector?
							</h1>
						</Fade>
...
export default AutomotiveCards;
