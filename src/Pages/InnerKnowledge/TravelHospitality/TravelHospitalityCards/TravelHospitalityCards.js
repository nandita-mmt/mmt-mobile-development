...
import './TravelHospitalityCards.scss';

const TravelHospitalityCards = () => {
	const responsive = {
		0: {
			items: 1,
		},
	...
	return (
		<div className='TravelHospitalityCards'>
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
					...
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Putting travel and Hospitality at the forefront of the evolving field empowered by
								Blockchain, AI-ML & Core Tech
							</h1>
						</Fade>
						...
						<Fade bottom>
							<p className='font-300 text-center mt-4 '>
								...
								Technologies, we equip Finance & Banking sectors with solutions or insights with
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Potential Uses Of Blockchain In Travel & Hospitality
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>Securing Payments</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Strengthening Identification & Security</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
								...
								<div className='d-flex flex-row justify-content-start align-items-start'>
									...
									<p className='mb-0 font-400'>Tracking Customer Belongings</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
				...
				<Row className='align-items-center justify-content-center'>
					...
					<Col md lg={6} className='position-relative py-5'>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of AI-ML In Travel & Hospitality
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>Chatbots For Customer Service</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Virtual Customer Service</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Real-time Data Analysis & Processing</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>AR/VR</p>
								</div>
							</div>
						</Fade>
					</Col>
				...
				<Row className='align-items-center justify-content-center'>
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of Core Tech In Travel & Hospitality
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								...
								<div className='d-flex flex-row justify-content-start align-items-start'>
									...
									<p className=' mb-0 font-400'>Digital Experience</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Salesforce</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
								...
								<div className='d-flex flex-row justify-content-start align-items-start'>
									...
									<p className='mb-0 font-400'>Process Automation & Digital Integration</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
				<Row className='align-items-center justify-content-center'>
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Where Do You Stand With New-Age tech’s Possibilities For The Travel & Hospitality
								Business Sector?
							</h1>
						</Fade>
						...
						<Fade bottom>
							<p className='font-300 text-center mt-4 '>
								We’ll take it from here. We’ll draft the perfect plan your Real Estate business.
							</p>
						</Fade>
						<Row className='align-items-center justify-content-center py-4'>
							<Col md lg={6}>
					...
					<Col md lg={12}>
						...
						<Fade bottom>
							<p className='font-300 text-center mt-5 pt-3'>
								We assist businesses from all verticals. Deploying industry-best processes,
								innovative tech solutions and effective technologies that empower ventures of every
								sizes envision a new path of functionality for the future.
							</p>
						</Fade>
					</Col>{' '}
...
export default TravelHospitalityCards;
