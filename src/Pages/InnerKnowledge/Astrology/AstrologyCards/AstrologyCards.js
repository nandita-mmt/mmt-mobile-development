...
const AstrologyCards = () => {
	...
	const DataArray = [
		{
			title: 'The Potential Uses Of Blockchain In Astrology Consultation Businesses',
			description: [
				{ desc: 'Securing Payments' },
				{ desc: 'Strengthening Consultation Identification & Security' },
				{ desc: 'Boosting Loyalty Programs' },
				{ desc: 'Inventory Tracking' },
			],
		},
		{
			title: 'The Uses Of AI-ML For Astrology Consultation Businesses',
			description: [
				{ desc: 'Real-Time Analysis Of Customer’s Birth Chart' },
				{
					desc: 'Enabling Real-Time Astrological Forecasting',
				},
				{ desc: 'Chatbots For Quick Consultatione' },
				{ desc: 'Real-time Data Analysis & Processing For Quick Solutions' },
			],
		},
		{
			title: 'The Uses Of Core Tech For Astrology Consultation Businesses',
			description: [
					...
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Putting Astro Consultation ventures at the forefront of the evolving field empowered
			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
				<Row className='align-items-center justify-content-center'>
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Where Do You Stand With New-Age Tech’s Possibilities For The Astrology Consultation
								Business?
							</h1>
						</Fade>
					...
					<Row className='align-items-center justify-content-center '>
						...
						>
							<div className='mmt-car-content px-4 py-5 mmt-about-service-in'>
								<h3 className='mt-5 font-700 astrology-card-header text-center text-lg-start'>
									Engaging <br />
									Apps
								</h3>
								<p className='mb-5 font-300 text-center text-lg-start'>
