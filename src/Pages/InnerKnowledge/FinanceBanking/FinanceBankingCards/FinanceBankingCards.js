...
import './FinanceBankingCards.scss';

const FinanceBankingCards = () => {
	const responsive = {
		0: {
			items: 1,
		},
	...
	return (
		<div className='FinanceBankingCards'>
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
					...
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Putting Finance & Banking sector at the forefront of the evolving field empowered by
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Potential Uses Of Blockchain In Finance & Banking
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>
										Authenticating KYC/AML Data, Real-Time Verification Of Financial Documents
									</p>
								</div>
								...
								<div className='d-flex flex-row justify-content-start align-items-start'>
									...
									<p className='mb-0 font-400'>
										Streamlining Credit Predictions & Scoring With User Activity
									</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
									...
									<p className='mb-0 font-400'>
										Automating Fund disbursement, Underwriting & Syndicate Formation
									</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
									...
									<p className='mb-0 font-400'>
										Facilitating Collateralisation of Assets In Real-Time
									</p>
								</div>
							</div>
						</Fade>
				...
				<Row className='align-items-center justify-content-center'>
					...
					<Col md lg={6} className='position-relative py-5'>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of AI-ML In Finance & Banking
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
								<div className='d-flex flex-row justify-content-start align-items-start mt-4 mb-0'>
									...
									<p className=' mb-0 font-400'>Real-Time Analysis Of Customer’s Account Data</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									...
									<p className='mb-0 font-400'>
										Transforming Complex Transaction Data Into Convenient-To-Read Information
									</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
									...
									<p className='mb-0 font-400'>Enabling Real-Time Financial Forecasting</p>
								</div>
								<div className='d-flex flex-row justify-content-start align-items-start'>
									<div>
										<BiCircle className='icon-circ-purp' size={15} />
									</div>
									<p className='mb-0 font-400'>Chatbots Streamlining Communication Channel</p>
								</div>
							</div>
						</Fade>
					</Col>
				...
				<Row className='align-items-center justify-content-center'>
					...
					>
						<Fade bottom>
							<h2 className='text-center text-lg-start font-500'>
								The Uses Of Core Tech In Finance & Banking
							</h2>
						</Fade>
						<Fade bottom>
							<div className='mmt-project-details pb-4 px-4 d-flex flex-column align-items-start'>
			...
			<Container className='mmt-papercard-container w-100 h-100 mt-5 '>
				<Row className='align-items-center justify-content-center'>
					<Col md lg={12}>
						<Fade bottom>
							<h1 className='font-xl font-200 text-center'>
								Where Do You Stand With New-Age tech’s Possibilities For The Finance & Banking
								Sector?
							</h1>
						</Fade>
...
export default FinanceBankingCards;
